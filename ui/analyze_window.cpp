...
{
    UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusStartNormalReplay);
...
absl::Status AnalyzeDialog::Pm4Replay(Dive::DeviceManager &device_manager,
                                      const std::string   &remote_gfxr_file)
{
    UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusStartPm4Replay);
    Dive::GfxrReplaySettings replay_settings;
    replay_settings.remote_capture_path = remote_gfxr_file;
    replay_settings.local_download_dir = m_local_capture_file_directory.string();
...
absl::Status AnalyzeDialog::PerfCounterReplay(Dive::DeviceManager &device_manager,
                                              const std::string   &remote_gfxr_file)
{
    UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusStartPerfCounterReplay);
    Dive::GfxrReplaySettings replay_settings;
    replay_settings.remote_capture_path = remote_gfxr_file;
    replay_settings.local_download_dir = m_local_capture_file_directory.string();
...
absl::Status AnalyzeDialog::GpuTimeReplay(Dive::DeviceManager &device_manager,
                                          const std::string   &remote_gfxr_file)
{
    UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusStartGpuTimeReplay);
    Dive::GfxrReplaySettings replay_settings;
    replay_settings.remote_capture_path = remote_gfxr_file;
    replay_settings.local_download_dir = m_local_capture_file_directory.string();
...
void AnalyzeDialog::ReplayImpl()
{
    ...
    UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusSetup);
    ...
    if (!ret.ok())
    {
        ...
        UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusSetupDeviceFailure, err_msg);
        return;
    }
    ...
    if (!asset_file.ok())
    {
        ...
        UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusFailure, err_msg);
        return;
    }
    ...
    if (normal_run_enabled)
    {
        ...
        UpdateReplayStatus(ReplayStatusUpdateCode::kReplayStatusSuccess);
